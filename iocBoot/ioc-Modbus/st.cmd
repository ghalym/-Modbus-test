#!/reg/neh/home/klauer/Repos/ads-ioc/bin/rhel7-x86_64/adsIoc
...
epicsEnvSet("LOCATION", "PLC:Modbus" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:Modbus")
dbLoadRecords("save_restoreStatus.db", "P=PLC:Modbus:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:Modbus")
...
save_restoreSet_status_prefix( "PLC:Modbus:" )
